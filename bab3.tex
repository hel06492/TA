...
Pada tahap pengolahan awal ukuran dan resolusi foto diperkecil untuk mengurangi beban pemrosesan sistem. Citra \emph{grayscale} dipersiapkan dari foto yang telah diperkecil ukuran dan resolusinya.

\subsubsection{Deteksi Tepi dengan Algoritma Canny}

Deteksi tepi dilakukan pada citra \emph{grayscale}, komponen warna merah (R) dan komponen warna hijau (G).
